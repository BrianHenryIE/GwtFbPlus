...
public class FBEvent {
	...
	public native void subscribe(String event, AsyncCallback<JavaScriptObject> callback ) /*-{
		...
		$wnd.FB.Event.subscribe(event,function(response){
			app.@ie.sortons.gwtfbplus.client.api.FBEvent::callbackSuccess(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/google/gwt/core/client/JavaScriptObject;)(callback,response);
		});
	}-*/;
