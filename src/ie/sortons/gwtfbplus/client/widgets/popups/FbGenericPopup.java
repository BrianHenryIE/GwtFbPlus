...
public class FbGenericPopup extends PopupPanel {
	...
	private static NoteActionPopupUiBinder uiBinder = GWT.create(NoteActionPopupUiBinder.class);
	...
	Label note;
	@UiField
	Label textAreaQuestion;
	@UiField
	TextArea input;
	@UiField
	SimplePanel addWidget;

	@UiField
	BlueButton okButton;
	@UiField
	GreyButton cancelButton;
